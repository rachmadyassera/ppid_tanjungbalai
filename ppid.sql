...
-- Dumping database structure for ppidtanjungbalai_iph
CREATE DATABASE IF NOT EXISTS `ppidtanjungbalai_iph` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `ppidtanjungbalai_iph`;

-- Dumping structure for table ppidtanjungbalai_iph.dokumen_informasi
...
-- Dumping data for table ppidtanjungbalai_iph.dokumen_informasi: ~0 rows (approximately)
/*!40000 ALTER TABLE `dokumen_informasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `dokumen_informasi` ENABLE KEYS */;

-- Dumping structure for table ppidtanjungbalai_iph.permohonan_informasi
...
-- Dumping data for table ppidtanjungbalai_iph.permohonan_informasi: ~0 rows (approximately)
/*!40000 ALTER TABLE `permohonan_informasi` DISABLE KEYS */;
/*!40000 ALTER TABLE `permohonan_informasi` ENABLE KEYS */;

-- Dumping structure for table ppidtanjungbalai_iph.tbl_opd
...
-- Dumping data for table ppidtanjungbalai_iph.tbl_opd: ~2 rows (approximately)
...
-- Dumping structure for table ppidtanjungbalai_iph.tbl_pengguna
...
-- Dumping data for table ppidtanjungbalai_iph.tbl_pengguna: ~2 rows (approximately)
...
-- Dumping structure for table ppidtanjungbalai_iph.tindaklanjut_informasi
...
-- Dumping data for table ppidtanjungbalai_iph.tindaklanjut_informasi: ~0 rows (approximately)
