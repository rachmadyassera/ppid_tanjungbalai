        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/dashboard'?>"><span class="fa fa-backward"></span> Kembali Ke Dashboard</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <center> Mohon Maaf , Halaman ini hanya bisa di Akses Oleh <b>" Administrator "</b> Terimakasih</center>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
