...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Sikomplit System | Data Pengguna Aplikasi 
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-user-plus"></span> Tambah Pengguna Baru</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
  ...
  <footer class="main-footer">
    ...
    <strong><?php echo date('Y');?> © Copyright <a href="http://tanjungbalaikota.go.id">Pemerintah Kota Tanjungbalai</a>.</strong>
  </footer>
