...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
<tr>
<td class="h2-white left pb20" style="color:#ffffff; font-family:Arial, sans-serif; font-size:52px; line-height:58px; text-transform:uppercase; font-weight:bold; text-align:center; padding-bottom:20px;"><multiline>PPID Notify <br /></multiline></td>
</tr>
<tr>
<td class="text4 left pb20" style="color:#d2d4ff; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:24px; text-align:center; padding-bottom:20px;"><multiline>Permohonan informasi sudah kami terima, kami akan melakukan peninjauan atas permohonan anda.</multiline></td>
</tr>
<!-- Button -->
...
<tr>
<td class="section-title" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:14px; line-height:20px; text-align:center; padding-bottom:40px; text-transform:uppercase;"><multiline>IDPI&nbsp; A n d a</multiline></td>
</tr>
<tr>
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
error_reporting(0);
$b=$data->row_array();
$idpi=strip_tags($b['idpi']);

?>				
<td class="text-title2 pb15 m-center" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:20px; line-height:24px; text-align:center; padding-bottom:15px;"><multiline><?php echo $idpi; ?></multiline></td>
</tr>
<tr>

<td class="text-title2 pb15 m-center" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:20px; line-height:24px; text-align:left; padding-bottom:15px;"><multiline>Diberitahukan agar anda menyimpan IDPI Permohonan anda, dan untuk melihat progress permohonan informasi anda dapat melihat melalui website PPID, dan memasukan IDPI anda, pada Laporan Pelayanan Informasi, input pada kolom pencarian yang tersedia pada tabel laporan pelayanan informasi. Terimakasih</multiline></td>
</tr>
...
<tr>
<td class="text-footer pt30" style="color:#a9ace3; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:20px; text-align:center; padding-top:30px;"><multiline>Copyright &copy; PPID System <br /> Tanjungbalai Sumatera Utara</multiline></td>
</tr>
</table>
</td>
</tr>
