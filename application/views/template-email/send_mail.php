...
error_reporting(0);
$b=$data->row_array(); 
$keterangan=strip_tags($b['keterangan_tindaklanjut']);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
<tr>
<td class="h2-white left pb20" style="color:#ffffff; font-family:Arial, sans-serif; font-size:52px; line-height:58px; text-transform:uppercase; font-weight:bold; text-align:center; padding-bottom:20px;"><multiline>PPID Progress</multiline></td>
</tr>
<tr>
<td class="text4 left pb20" style="color:#d2d4ff; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:24px; text-align:center; padding-bottom:20px;"><multiline>Terimakasih sudah menunggu progress permohonan informasi, kami telah melakukan peninjauan atas permohonan anda. Pesan ini dikirim oleh sistem pada aplikasi PPID (Pejabat Pengelola Informasi dan Dokumentasi), mohon untuk tidak membalas pesan ini,  Berikut hasil tindak lanjutnya.</multiline></td>
</tr>
<!-- Button -->
...
<tr>
<td class="img-center pb20" style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom:20px;"><img src="<?php echo base_url().'theme/images/logo-pemko.png'?>" width="190" height="240" editable="true" border="0" alt="" /></td>
</tr>
<tr>
<td class="section-title" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:14px; line-height:20px; text-align:center; padding-bottom:40px; text-transform:uppercase;"><multiline>P R O G R E S S &nbsp; <?= $b['idpi']; ?> </multiline></td>
</tr>
<?php if($b['status']==1):?>
    <tr>
    <td class="text-title2 pb15 m-center" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:20px; line-height:24px; text-align:left; padding-bottom:15px;"><multiline><center> D I   S E T U J U I </center> </multiline></td>
    </tr>
<?php else:?>   
    <tr>
    <td class="text-title2 pb15 m-center" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:20px; line-height:24px; text-align:left; padding-bottom:15px;"><multiline>D I   T O L A K</multiline></td>
    </tr>
<?php endif;?>
<tr>
<td>
...
<tr>
<td class="text-title2 pb15 m-center" style="color:#000000; font-family:'Noto Serif', Georgia, serif; font-size:20px; line-height:24px; text-align:left; padding-bottom:15px;"><multiline><?php echo $keterangan;?></multiline></td>
</tr>
<?php if($b['status']==1):?>
    <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td class="social-title pb30" style="color:#ffffff; font-family:'Raleway', Arial, sans-serif; font-size:14px; line-height:22px; text-align:center; text-transform:uppercase; padding-bottom:30px;"><multiline>P e m e r i n t a h &nbsp; K o t a &nbsp;  T a n j u n g b a l a i</multiline></td>
</tr>
...
<tr>
<td class="text-footer pt30" style="color:#a9ace3; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:20px; text-align:center; padding-top:30px;"><multiline>Copyright &copy; PPID - Pejabat Pengelola Informasi dan Dokumentasi <br /> Pemerintah Kota Tanjungbalai Sumatera Utara</multiline></td>
</tr>
</table>
</td>
</tr>
